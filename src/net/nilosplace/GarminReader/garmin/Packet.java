...
//	USB Protocol Layer Packet Id
	...
	private short packetType = -1;
	private byte[] packetData;
	
	public Packet() {
		packetType = Packet.Unknown_Unknown_Unknown;
	...
	public Packet(short packetType, byte[] packetDate) {
		this.packetType = packetType;
		this.packetData = packetDate;
	}
