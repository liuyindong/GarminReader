...
/**
* Class made to be able to test the classes of the dk.itu.haas.GPS-package.
*/
public class ClassTester implements IGPSlistener, GarminListener, IWaypointListener {	
	...
	public ClassTester() {				
		...
		// Open port.
		try {
			port = (SerialPort) CommPortIdentifier.getPortIdentifier("COM1").open("dk.itu.haas.GPS", 3000);
