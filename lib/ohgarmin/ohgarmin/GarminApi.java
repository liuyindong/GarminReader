	...
	private UsbPipe pipeOut = null;
		...
		public void useUsbDevice(int nummer){
			try{
				...
				System.out.println("Nummer des Devices ist nicht g��ltig");
			}
		}
		...
		//Bekommt einen UsbHub und findet die dranh��ngenden Devices
		public void findDevices(UsbHub hub){
		    ...
		    while (iterator.hasNext()) {
	        	...
	        	//falls Ger��t ein Hub ist dann bitte nochmals rekurisv
	        	// durchgehn
		        if (device.isUsbHub()) {
		...
		public void getPipes(UsbDevice device){
			try{
				...
				System.out.println("Kein Ger��t gefunden");
				System.exit(0);
		...
		//Wichtigste Methode f��r die API - hier findet die Kommunikation statt mit dem Ger��t
		...
		//manchen Funktionen ist das unerw��nscht BSP: PowerOff
		...
		//dies braucht man vor jeder ��bertragung
